"""
Django settings for FOF project.
...
SECRET_KEY = 'django-insecure-q((2jp@*d5tdk-8s4-!(x)$c6+j7%z^%1x11_dn&lt@kb8r&s3'
...
MIDDLEWARE = [
    ...
    'middleware.AdminIPWhitelistMiddleware',
]
...
WSGI_APPLICATION = 'FOF.wsgi.application'
...
MEDIA_URL='/IMG_PRODUCT/'
MEDIA_ROOT=os.path.join(BASE_DIR, 'IMG_PRODUCT')
